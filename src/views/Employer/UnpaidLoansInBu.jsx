...
const handlePayment=()=>{
  localStorage.setItem("netPayableAmount",netPayableAmount)
  history.push("/employer/payment/BU0001")
    ...
    <>
      ...
      <div
        className={
          ...
          (color === "light" ? "bg-white" : "bg-theme2 text-bold text-white")
        }
      >
            ...
            <div className="flex flex-wrap">
              <div className="w-full lg:w-12/12 px-4">
                <div className="relative w-full mb-3">
                  ...
                  <button onClick={handlePayment} className=" mt-10 bg-emerald-500 text-white active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">
                    PAY  ₹ {" "}
                    {netPayableAmount}
                  </button>
...
export default UnpaidLoansInBu