...
import { legalEntitesInAGroupbyCodeApi } from 'actions/legalEntityActions';
import { salaryScheduleExistsApi } from 'actions/salaryScheduleActions';
import NoSalaryScheduleExists from 'components/Errors/NoSalaryScheduleExists';
import AddNewEmployeeExcelUpload from 'components/Forms/AddNewEmployeeExcelUpload';
import EmployeeInfo2 from 'components/Forms/EmployeeInfo2';
import React, { useEffect, useState } from 'react'
import { useDispatch, useSelector } from 'react-redux';

const AddnewEmployees = () => {
    const { loading: ll, salaryExist } = useSelector((state) => state.salaryScheduleExists.salaryScheduleExists)
    console.log("salaryScheduleExists", salaryExist)
    ...
    }, [size, pageNo, groupCode, leCode, buCode, salaryExist])
    ...
    if(salaryExist==false){
        return (
            <NoSalaryScheduleExists code ={buCode}/>
        )
    }
                ...
                <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                    <form>
                        ...
                        <div className="flex flex-wrap">
                            {
                                buCode &&
                                <AddNewEmployeeExcelUpload bu={buCode} />
