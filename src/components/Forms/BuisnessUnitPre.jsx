...
import { createBuisnessUnitInACompanyApi } from "actions/buInACompanyActions";
...
export default function BuisnessUnitPre({companyId ,companyCode }) {
    ...
    const { loading, error, success } = useSelector((state) => state.buInAComp);
    ...
    const onSubmit = (formData) => {
        ...
        dispatch(createBuisnessUnitInACompanyApi(formData, companyCode, flag))
        history.push(`/admin/unitsInACompany/${companyId}`);
        ...
        <>
            <div className="relative items-stretch flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
                ...
                <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                    ...
                    <label
                        className=" pt-6 text-xl block uppercase text-blueGray-600 text-xs font-bold mb-2"
                        htmlFor="grid-password"
                    >
                       Creating new unit in {companyCode}
                    </label>
