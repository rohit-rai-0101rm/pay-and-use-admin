...
import { bulevelProductUpdateApi } from 'actions/loanActions'
import { productFilterApi } from 'actions/loanActions'
import React, { useEffect, useState } from 'react'
import { useAlert } from 'react-alert'
import { useDispatch, useSelector } from 'react-redux'

const LoanUpdateProductForm = ({ wantToUpdate, setWantToUpdate, updatingLoanType, buCode}) => {
    ...
    const handleSave = () => {
        if (productCode == null) {
            ...
            dispatch(bulevelProductUpdateApi(buCode,  updatingLoanType, productCode))
    ...
    useEffect(() => {
        ...
        dispatch(breakUpApi(productCode))


    }, [dispatch, updatingLoanType, , buCode,  productCode]);
    return (
        <>
            {
                wantToUpdate &&
                        ...
                        <form>
                            ...
                            <div className="flex flex-wrap">
                                ...
                                <div className="w-full lg:w-6/12 px-4 py-2">
                                    ...
                                    <select onChange={(e) => setProductCode(e.target.value)} className={"border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"} aria-label="Default select example">
...
export default LoanUpdateProductForm