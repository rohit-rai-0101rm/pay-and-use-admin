...
const NoSalaryScheduleExists = ({ code }) => {
    ...
    const handleCreate = () => {
        ...
        history.push(`/admin/basicInfo/${code}`)
    }
            ...
            <div class="px-40 py-20 bg-white rounded-md shadow-xl">
                <div class="flex flex-col items-center">
                    ...
                    <h6 class="mb-2 text-2xl font-bold text-center text-gray-800 md:text-3xl">
                        <span class="text-red-500">Oops!</span> No Salary chedule found for this Buisness Unit
                    </h6>
...
export default NoSalaryScheduleExists