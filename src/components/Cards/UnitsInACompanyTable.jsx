...
export default function UnitsInAGroupCardTable({ companyName,color,unitsInACompany }) {
  console.log(unitsInACompany)
        ...
        <div className="rounded-t mb-0 px-4 py-3 border-0">
          <div className="flex flex-wrap items-center">
            <div className="relative w-full px-4 max-w-full flex-grow flex-1">
              ...
              >
                All buisness Units in {companyName}
              </h3>
            </div>
          </div>
        </div>
...
UnitsInAGroupCardTable.defaultProps = {
  color: "dark",
};

UnitsInAGroupCardTable.propTypes = {
