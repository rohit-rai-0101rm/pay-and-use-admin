...
export default function AllEmployeeCardTable({ color }) {
  const renderHeader = () => {
    let headerElement = ['Employee','name','operation']
...
AllEmployeeCardTable.defaultProps = {
  color: "light",
};

AllEmployeeCardTable.propTypes = {
