...
const ApplicationApprovedTable = ({data}) => {
    const color="light"
      ...
      return (
        <>
          ...
          <center >
                ...
                <button onClick={openModal} className=" mt-10 mb-2 bg-emerald-500 text-white active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" >UPDATE</button>
...
export default ApplicationApprovedTable