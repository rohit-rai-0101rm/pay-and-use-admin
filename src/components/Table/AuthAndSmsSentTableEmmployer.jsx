...
const AuthAndSmsSentTableEmmployer = ({ data }) => {
                            ...
                            {pg.map(row => {
                                ...
                                return (
                                    <tr className="border-t-0 px-6  border-l-0 border-r-0 text-xs whitespace-nowrap p-4" {...row.getRowProps()}>
                                        {row.cells.map(cell => {
                                            return <td className="px-6 py-6 text-black font-bold   whitespace-nowrap text-left"  {...cell.getCellProps()}>{cell.render('Cell')}</td>
                                        })}
                                    </tr>
                                )
                            })}
...
export default AuthAndSmsSentTableEmmployer