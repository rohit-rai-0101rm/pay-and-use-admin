...
import { aadharUploadApi } from "actions/fileUploadActions";
import { aadharBackUploadApi } from "actions/fileUploadActions";

export default function AadharBackUploadTable({ }) {
...
const dispatch=useDispatch()
    ...
    const handleConfirm = () => {
        if (!isFileUploaded) {
            ...
            if (isFileUploaded) {
                dispatch(aadharBackUploadApi(file,empCode,buCode))
...
AadharBackUploadTable.defaultProps = {
    color: "light",
};

AadharBackUploadTable.propTypes = {
