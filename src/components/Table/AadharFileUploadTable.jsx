...
export default function AadharFileUploadTable({ }) {
...
const dispatch=useDispatch()
    ...
    const handleConfirm = () => {
        if (!isFileUploaded) {
            ...
            if (isFileUploaded) {
                dispatch(aadharUploadApi(file,empCode,buCode))
...
AadharFileUploadTable.defaultProps = {
    color: "light",
};

AadharFileUploadTable.propTypes = {
